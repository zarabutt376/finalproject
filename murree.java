...
public class Murree extends AppCompatActivity {
    ...
    {
        Intent intent = new Intent (this, activityHotelMurree.class );
    ...
    {
        Intent intent = new Intent (this, mureedestination.class );
        startActivity(intent);
    }
    ...
    {
        Intent intent = new Intent (this, mureerestaurant.class );
        startActivity(intent);
    }
}